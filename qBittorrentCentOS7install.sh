...
# Install libtorrent
cd ~
wget --no-check-certificate https://github.com/arvidn/libtorrent/releases/download/v1.2.19/libtorrent-rasterbar-1.2.19.tar.gz
if [ $? -eq 0 ];then
...
tar -zxf libtorrent-rasterbar-1.2.19.tar.gz
...
# Install qBittorrent
cd ~
wget --no-check-certificate https://github.com/qbittorrent/qBittorrent/archive/release-4.5.4.tar.gz
if [ $? -eq 0 ];then
...
tar -xzvf release-4.5.4.tar.gz
cd qBittorrent-release-4.5.4
