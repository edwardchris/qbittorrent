...
# Install libtorrent
cd ~
wget --no-check-certificate https://github.com/arvidn/libtorrent/releases/download/v2.0.9/libtorrent-rasterbar-2.0.9.tar.gz
if [ $? -eq 0 ];then
...
tar -zxf libtorrent-rasterbar-2.0.9.tar.gz
